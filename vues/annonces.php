                ...
                <div class="annonce-box">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between">
                            <h2 class="pl-0"><?= $ad->getTitle(); ?></h2>
                            <div class="gray">Annonce #<span class="id"><?= $ad->getId(); ?></div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-3">
                                    <span class="id gray">user_id: <?= $ad->getUserId(); ?></span>
                                    <span class="id gray">car_id: <?= $ad->getCarId(); ?></span>
                                </div>
                                <div class="col-9 text-right">
                                    <a class="pl-4 getUpdateModal" href="#" data-toggle="modal"
                                        data-target="#updateModal" data-id="<?= $ad->getId(); ?>">Modifier l'annonce</a>
                                    <a class="pl-4 text-danger" href="#!" data-toggle="modal" data-target="#deleteModal"
                                        data-id="<?= $ad->getId(); ?>">Supprimer l'annonce</a>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="ads_update.php" name="adsUpdateForm" id="adsUpdateForm">
                    <div class="form-group">
                        <input id="updateId" class="form-control" type="text" name="id" hidden>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12 text-right">
                            <button id="submit-update" type="submit" class="text-center btn btn-success"
                                data-confirm="modal">Modifier</button>
                            <button type="button" class="ml-2 btn btn-secondary" data-dismiss="modal">Fermer</button>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <p>Cette action supprimera toutes les réservations et les commentaires associés.</p>
                    </div>
                </div>
                <form action="ads_delete.php" method="post" name="deleteAdForm" id="deleteAdForm">
                    <div class="form-group">
                        <input id="deleteId" type="text" name="id" hidden>
                    </div>
                    <div class="row">
                        <div class="col-12 text-right">
